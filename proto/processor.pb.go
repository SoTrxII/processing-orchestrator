...
var file_proto_processor_proto_rawDesc = []byte{
	...
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0xc8,
...
var file_proto_processor_proto_depIdxs = []int32{
	2, // 0: processing_orchestrator.RecordService.Start:input_type -> processing_orchestrator.ProcessRequest
	0, // 1: processing_orchestrator.RecordService.Watch:input_type -> processing_orchestrator.WatchRequest
	3, // 2: processing_orchestrator.RecordService.Start:output_type -> processing_orchestrator.ProcessResponse
	1, // 3: processing_orchestrator.RecordService.Watch:output_type -> processing_orchestrator.ProcessingStatus
